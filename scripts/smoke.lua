...
assert(not (vim.fn.readfile(python_tmpdir .. "/Makefile")[1] or ""):match("^# %*+ #$"), "Python Makefile got a 42 header")
...
local python_gitignore = table.concat(vim.fn.readfile(python_tmpdir .. "/.gitignore"), "\n")
assert(python_gitignore:find(".venv/", 1, true), "Python .gitignore missing .venv")
assert(python_gitignore:find(".coverage.*", 1, true), "Python .gitignore missing coverage files")
